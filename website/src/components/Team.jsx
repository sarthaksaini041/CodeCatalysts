...
const OrbitalDisplay = ({ activeMember, allMembers, onSelectMember }) => {
  ...
  const others = allMembers.filter((member) => member.name !== activeMember.name);
  ...
  useEffect(() => {
    const updatePositions = () => {
      ...
      if (ring1Ref.current && ring1Members.length > 0) {
      ...
      if (ring2Ref.current && ring2Members.length > 0) {
      ...
      <div style={{ position: 'relative', width: '340px', height: '340px' }}>
        <div
          style={{
            ...
            top: '50%',
            left: '50%',
            width: `${RING1_RADIUS * 2}px`,
            height: `${RING1_RADIUS * 2}px`,
            marginTop: `-${RING1_RADIUS}px`,
            marginLeft: `-${RING1_RADIUS}px`,
            borderRadius: '50%',
        ...
        {ring2Members.length > 0 && (
          <div
            style={{
              ...
              top: '50%',
              left: '50%',
              width: `${RING2_RADIUS * 2}px`,
              height: `${RING2_RADIUS * 2}px`,
              marginTop: `-${RING2_RADIUS}px`,
              marginLeft: `-${RING2_RADIUS}px`,
              borderRadius: '50%',
          ...
          return (
            <div
              ...
              style={{
                ...
                background: index % 2 === 0 ? 'rgba(0,212,255,.25)' : 'rgba(167,139,250,.25)',
                boxShadow: index % 2 === 0 ? '0 0 6px rgba(0,212,255,.4)' : '0 0 6px rgba(167,139,250,.4)',
                pointerEvents: 'none',
              }}
            />
          );
          ...
          >
            ...
            >
              ...
              <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap', marginBottom: '1.2rem' }}>
                {[member.role, member.department].map((badge, index) => (
                  <span
                    key={index}
                    style={{
                      padding: '5px 14px',
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      <span style={{ fontSize: '3.5rem', fontWeight: 700, color, opacity: 0.5 }}>
                        {member.name
                          .split(' ')
                          .map((word) => word[0])
                          .join('')}
                    ...
                    <div
                      style={{
                        ...
                        right: 0,
                        height: '100px',
                        background: 'linear-gradient(transparent, rgba(12,12,28,.95))',
                        pointerEvents: 'none',
                      }}
                    />
                  </div>
      ...
      <AnimatePresence>
        {selectedMember && (
          <MemberPanel
            ...
            onSwitch={(member) => setSelectedMember(member)}
          />
        )}
      </AnimatePresence>
