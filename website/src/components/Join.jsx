...
import { Instagram, Linkedin, Mail, Zap, ArrowUpRight } from 'lucide-react';
...
const Join = () => {
  return (
    <footer id="join" style={{
      ...
      <div className="container" style={{ position: 'relative', zIndex: 10, maxWidth: '1100px', margin: '0 auto', padding: '0 2rem' }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            width: '60%', height: '80%',
            background: 'radial-gradient(circle, rgba(0,212,255,.04), transparent 60%)',
          ...
          <div style={{ position: 'relative', zIndex: 2 }}>
            ...
            <h2 style={{
              ...
              Become a <span className="text-gradient">Catalyst</span>
            </h2>
            <p style={{
              color: 'rgba(160,175,195,.7)', maxWidth: '520px', margin: '0 auto 2rem auto',
            ...
            <Link to="/apply" className="glass-btn glass-btn-primary"
              style={{ padding: '0.9rem 2rem', textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: '6px' }}>
              Join the Build Squad <ArrowUpRight size={16} />
            </Link>

            <p style={{ color: 'rgba(120,130,150,.6)', marginTop: '1.5rem', fontSize: '0.82rem', lineHeight: 1.6 }}>
              Takes about 3 minutes. We get back within 1-3 days.<br />
              Or drop us a line at{' '}
              <a href="mailto:team@codecatalysts.dev" style={{ color: 'var(--neon-cyan)', fontWeight: 500 }}>
        ...
        <div className="footer-grid">
          ...
          <div className="footer-col">
            ...
            <p style={{ color: 'rgba(160,175,195,.9)', fontSize: '0.85rem', lineHeight: 1.6, maxWidth: '260px' }}>
        ...
        <div style={{
          ...
          <p style={{ color: 'rgba(160,175,195,.7)', fontSize: '0.8rem', textAlign: 'center' }}>
